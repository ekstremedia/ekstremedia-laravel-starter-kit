...
<template>
    <AppLayout>
        <Head :title="t('notification_settings.title')" />

        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <h1 class="text-2xl font-bold mb-2">{{ t('notification_settings.title') }}</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-8">{{ t('notification_settings.desc') }}</p>
            ...
            <form @submit.prevent="submit" ref="sectionsRef" class="space-y-6">
                ...
                <div class="bg-white dark:bg-dark-900 rounded-2xl border border-gray-200 dark:border-dark-700 p-6 space-y-5">
                    <h2 class="text-lg font-semibold">{{ t('notification_settings.email_delivery') }}</h2>
                    ...
                    <label class="flex items-start gap-3 cursor-pointer">
                        ...
                        />
                        <div>
                            <span class="text-sm font-medium">{{ t('notification_settings.email_on_new') }}</span>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{{ t('notification_settings.email_on_new_desc') }}</p>
                        </div>
                    </label>

                    <!-- Digest frequency -->
                    <div>
                        <label class="text-sm font-medium block mb-2">{{ t('notification_settings.digest') }}</label>
                        <select
                        ...
                        >
                            <option value="none">{{ t('notification_settings.digest_none') }}</option>
                            <option value="daily">{{ t('notification_settings.digest_daily') }}</option>
                            <option value="weekly">{{ t('notification_settings.digest_weekly') }}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-dark-900 rounded-2xl border border-gray-200 dark:border-dark-700 p-6 space-y-4">
                    <h2 class="text-lg font-semibold">{{ t('notification_settings.per_type_title') }}</h2>
                    <p class="text-xs text-gray-500 dark:text-gray-400">{{ t('notification_settings.per_type_desc') }}</p>
                    ...
                    <label class="flex items-center gap-3 cursor-pointer">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm">{{ t('notification_settings.chat_messages') }}</span>
                        </div>
                    </label>
                    ...
                    <label class="flex items-center gap-3 cursor-pointer">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm">{{ t('notification_settings.account_updates') }}</span>
                        </div>
                    </label>
                    ...
                    <label class="flex items-center gap-3 cursor-pointer">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm">{{ t('notification_settings.system_alerts') }}</span>
                        </div>
                    </label>
                </div>
